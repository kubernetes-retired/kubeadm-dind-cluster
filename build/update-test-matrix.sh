...
test_matrix=(
    ...
    "test                        v1.15 flannel                  "
    "test                        v1.15 calico                   "
    "test                        v1.15 calico-kdd               "
    "test                        v1.15 weave                    "
    "test                        v1.15 bridge      containerd   "
    "test                        v1.15 ptp                      "
    "test_multiple_clusters      v1.15                          "
    "test_ipv4_only              v1.15 bridge      docker      y"
    "test_ipv6_only              v1.15 bridge      docker      y"
    "test_ipv6_only_nat64        v1.15 bridge      docker      y"
    "test_ipv6_only_ext_aaaa     v1.15 bridge      docker      y"
    "test_dual_stack_v4_svc_net  v1.15 bridge      docker      y"
    "test_src_release                                           "
    "test_src_master                                            "
)
