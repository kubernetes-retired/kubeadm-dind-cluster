...
EMBEDDED_CONFIG=y;DIND_IMAGE=mirantis/kubeadm-dind-cluster:${DIND_FIXED_IMAGE_TAG:-v1.12};DOWNLOAD_KUBECTL=y;KUBECTL_VERSION=v1.12.3;KUBECTL_LINUX_SHA1=4248b9e621af7e902c9d23bf772a2ee8e50146c5;KUBECTL_LINUX_URL=https://storage.googleapis.com/kubernetes-release/release/v1.12.3/bin/linux/amd64/kubectl;KUBECTL_DARWIN_SHA1=c7d4086fbdc58d81419f7643304de0bf356e11df;KUBECTL_DARWIN_URL=https://storage.googleapis.com/kubernetes-release/release/v1.12.3/bin/darwin/amd64/kubectl
