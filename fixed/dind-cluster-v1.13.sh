...
EMBEDDED_CONFIG=y;DIND_IMAGE=mirantis/kubeadm-dind-cluster:${DIND_FIXED_IMAGE_TAG:-v1.13};DOWNLOAD_KUBECTL=y;KUBECTL_VERSION=v1.13.0;KUBECTL_LINUX_SHA1=5c619006fa45afce6efc51db819aff7d5ba7ef0e;KUBECTL_LINUX_URL=https://storage.googleapis.com/kubernetes-release/release/v1.13.0/bin/linux/amd64/kubectl;KUBECTL_DARWIN_SHA1=264df4722e8f70301dd150d455baeae4a855d2fc;KUBECTL_DARWIN_URL=https://storage.googleapis.com/kubernetes-release/release/v1.13.0/bin/darwin/amd64/kubectl
