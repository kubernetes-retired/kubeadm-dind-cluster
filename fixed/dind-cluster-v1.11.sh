...
EMBEDDED_CONFIG=y;DIND_IMAGE=mirantis/kubeadm-dind-cluster:${DIND_FIXED_IMAGE_TAG:-v1.11};DOWNLOAD_KUBECTL=y;KUBECTL_VERSION=v1.11.5;KUBECTL_LINUX_SHA1=feebec8e5649223e586fc45850d8659274c87797;KUBECTL_LINUX_URL=https://storage.googleapis.com/kubernetes-release/release/v1.11.5/bin/linux/amd64/kubectl;KUBECTL_DARWIN_SHA1=450e6e17fe65e9d24cbbe39702ad7aa9103662d7;KUBECTL_DARWIN_URL=https://storage.googleapis.com/kubernetes-release/release/v1.11.5/bin/darwin/amd64/kubectl
